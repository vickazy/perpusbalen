			...
			<div class="main-content">
				<div class="main-content-inner">
                  ...
                  <div id="table-responsive">
                      <table id="anggota" class="table table-striped table-bordered table-hover" width="100%">
                          <thead>
                              <tr>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="blue bigger">Tambah Anggota</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
                        ...
                        <div class="form-group">
                            <label>Nama</label>
                            <div>
                                 <input class="form-control" type="text" name="nama" placeholder="Nama Anggota" required>
...
<div id="modal-import" class="modal" tabindex="-1">
    <div class="modal-dialog">
        <form action="<?php echo site_url('anggota/import') ?>" enctype="multipart/form-data" method="POST">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="blue bigger">Import anggota</h4>
            </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var table = $('#anggota').DataTable({
      ...
      "ajax":{
        url : "<?php echo site_url('anggota/data_server') ?>",
        type : "POST"
      },
      ...
      [
        ...
        },
        {
          ...
          "render":function(data,tipe,full,meta){
            return '<a href="<?php echo site_url("anggota/edit/") ?>'+data["nis"]+'" class="btn btn-success btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>&nbsp; <form action="<?=site_url('anggota/hapus')?>" method="POST" style="display: inline;" accept-charset="utf-8"><input type="text" name="nis" value='+data["nis"]+' hidden ><button class="btn btn-danger btn-rounded btn-sm" type="submit" onclick="clicked(event)"><span class="fa fa-trash"></span></button></form>'
          }
        }
      ],
